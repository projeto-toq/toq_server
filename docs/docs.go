...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/complexes/zip-codes": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "Complex zip code filters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_projeto-toq_toq_server_internal_adapter_left_http_dto.AdminListComplexZipCodesRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_projeto-toq_toq_server_internal_adapter_left_http_dto.AdminListComplexZipCodesRequest": {
            "type": "object",
            "properties": {
                "complexId": {
                    "type": "integer"
