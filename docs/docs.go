...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_projeto-toq_toq_server_internal_adapter_left_http_dto.ListDownloadURLsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_projeto-toq_toq_server_internal_adapter_left_http_dto.ListDownloadURLsResponse"
                        }
                    },
                    "204": {
                        "description": "No READY batch available"
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "github_com_projeto-toq_toq_server_internal_adapter_left_http_dto.DownloadEntryResponse": {
            "type": "object",
            "properties": {
                "assetType": {
                    "description": "AssetType matches the original assetType",
