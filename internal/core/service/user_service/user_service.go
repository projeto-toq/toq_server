...
type UserServiceInterface interface {
	...
	ConfirmEmailChange(ctx context.Context, userID int64, code string, deviceToken string) (tokens usermodel.Tokens, err error)
	...
	GetPhoto(ctx context.Context, userID int64) (photo []byte, err error)
	...
	PushOptIn(ctx context.Context, userID int64, deviceToken string) (err error)
	PushOptOut(ctx context.Context, userID int64) (err error)
