...
// @Success     200 {object} dto.ListProposalsResponse "Items include documents[].base64Payload, ownerViewed/ownerViewedAt, realtor.photoUrl and owner.photoUrl with engagement averages"
