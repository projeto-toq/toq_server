...
// DiscardDraftVersion remove uma versão draft não publicada, revertendo alterações em andamento.
//
...
// @Router     /listings/versions/discard [post]
// @Security   BearerAuth
func (lh *ListingHandler) DiscardDraftVersion(c *gin.Context) {
	...
	var request dto.DiscardDraftVersionRequest
	...
	c.JSON(http.StatusOK, dto.DiscardDraftVersionResponse{
		Success: true,
		Message: "Draft listing version discarded",
	})
}
