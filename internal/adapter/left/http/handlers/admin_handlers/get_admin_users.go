...
//	@Param        roleName          query  string false  "Filter by role name (supports '*' wildcard)" example("*manager*")
//	@Param        roleSlug          query  string false  "Filter by role slug (supports '*' wildcard)" example("*admin*")
//	@Param        roleStatus        query  int    false  "Filter by role status enum" example(1)
//	@Param        isSystemRole      query  bool   false  "Filter by system role flag" example(true)
//	@Param        fullName          query  string false  "Filter by full name (supports '*' wildcard)" example("*Silva*")
//	@Param        cpf               query  string false  "Filter by CPF (supports '*' wildcard)" example("123*456")
//	@Param        email             query  string false  "Filter by email (supports '*' wildcard)" example("*toq.com*")
//	@Param        phoneNumber       query  string false  "Filter by phone (supports '*' wildcard)" example("*119*")
//	@Param        deleted           query  bool   false  "Filter by deletion flag" example(false)
//	@Param        idFrom            query  int    false  "Filter by user ID (from)" example(100)
//	@Param        idTo              query  int    false  "Filter by user ID (to)" example(250)
//	@Param        bornAtFrom        query  string false  "Filter by birth date from (RFC3339 or YYYY-MM-DD)" example("1990-01-01")
//	@Param        bornAtTo          query  string false  "Filter by birth date to (RFC3339 or YYYY-MM-DD)" example("2000-12-31")
//	@Param        lastActivityFrom  query  string false  "Filter by last activity from (RFC3339 or YYYY-MM-DD)" example("2025-01-01T00:00:00Z")
//	@Param        lastActivityTo    query  string false  "Filter by last activity to (RFC3339 or YYYY-MM-DD)" example("2025-01-31T23:59:59Z")
