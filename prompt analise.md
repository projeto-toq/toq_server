...
- permitir criar, editar, listar e deletar (hard delete) permissões de acesso atualizando as tabelas permissions
- permitir criar, editar, listar e deletar (hard delete) associações de permissões a roles atualizando as tabelas role_permissions.
